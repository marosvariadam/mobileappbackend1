...
{
    /// <summary>One week of aggregated history for a single (athlete, exercise) pair.</summary>
    public class WeeklyFeatureVector
    {
        ...
        public double VolumeKg { get; set; }                   // sum of actualSets * actualReps * actualWeightKg
    ...
    /// <summary>Features for one week paired with the next week's 1RM delta as the label.</summary>
